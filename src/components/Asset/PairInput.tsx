	...
	return (
		<FormControl variant="standard" sx={{ width: '100%' }}>
			...
			<FormStack direction="row" justifyContent="space-between" alignItems="center">
				...
				<InputAmount id="ip-amount" type="number" placeholder='0.00' min={0} max={headerValue} sx={ value && value > 0 ? { color: '#fff' } : { color: '#adadad' }} value={value && value > 0 ? parseFloat(value.toFixed(3)) : ''} onChange={onChange} />
			</FormStack>
		</FormControl>
	)
}
