	...
	return cometData ? (
		<Grid container spacing={2}>
            ...
            background: '#252627'
					...
					<PriceValue><InputAmount type="number" value={cometData.lowerLimit} min={0} max={assetData.price} onChange={handleChangeLowerLimit} /></PriceValue>
          ...
          <CurrentPrice style={{ borderTop: '1px solid #444'}}><span style={{ fontSize: '9px' }}>Current:</span> {assetData.price.toLocaleString()} USD</CurrentPrice>
            ...
            background: '#252627'
					...
					<PriceValue><InputAmount type="number" value={cometData.upperLimit} min={assetData.price} onChange={handleChangeUpperLimit} /></PriceValue>
					<RangePair>USDi / {assetData.tickerSymbol}</RangePair>
