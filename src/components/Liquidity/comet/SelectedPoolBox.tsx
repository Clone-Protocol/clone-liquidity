...
const SelectedPoolBox: React.FC<Props> = ({ positionInfo }) => {
  return (
    <Box>
      ...
      <DetailBox>
        <SubTitle>Total collateral value <InfoTooltip title={TooltipTexts.totalValueComet} /></SubTitle>
        <div style={{ marginBottom: '15px' }}>${positionInfo.totalCollValue.toLocaleString()}</div>

        <SubTitle>Mulipool Comet Health Score <InfoTooltip title={TooltipTexts.cometdHealthScore} /></SubTitle>
