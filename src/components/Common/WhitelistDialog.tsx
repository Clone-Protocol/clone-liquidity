      ...
      <Dialog open={open} onClose={handleClose} TransitionComponent={FadeTransition} maxWidth={463}>
        <DialogContent sx={{ backgroundColor: '#080018', borderRadius: '10px', padding: '15px', width: { xs: '100%', md: '463px' } }}>
          <BoxWrapper>
            {!isWhitelisted ?
              <>
                <Box mb="21px"><Typography fontSize='24px' fontWeight={600} color='#b5fdf9'>Not a Whitelisted Wallet</Typography></Box>
              ...
              :
              <>
                <Box mb="21px"><Typography fontSize='24px' fontWeight={600} color='#b5fdf9'>Congratulations!</Typography></Box>
