  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} TransitionComponent={FadeTransition} maxWidth={350}>
        <DialogContent sx={{ backgroundColor: '#000', border: '1px solid #414e66', borderRadius: '10px', padding: '15px', width: { xs: '100%', md: '350px' } }}>
          <BoxWrapper>
            ...
            <Box><Typography variant='p'>More on </Typography><a href="https://docs.clone.so/legal-and-regulations/terms-of-use" target="_blank" rel="noreferrer"><Typography variant='p' color='#4fe5ff'>Clone Terms of Use.</Typography></a></Box>
