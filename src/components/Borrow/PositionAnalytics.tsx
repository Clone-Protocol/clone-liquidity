...
const PositionAnalytics = ({ tickerSymbol }: { tickerSymbol: string }) => {
  return (
    <Box>
      ...
      <DataBox>
        ...
        <Box><Typography variant="p_lg">430,459.13 {tickerSymbol}</Typography> <Typography variant='p' color='#989898'>($1,405,005 USD)</Typography> <TxtPriceRate val={245345.55} rate={1.58} /></Box>
      </DataBox>
      <DataBox>
