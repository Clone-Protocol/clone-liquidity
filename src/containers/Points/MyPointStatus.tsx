  ...
  return (
    <Wrapper>
      ...
      <Stack direction='row' gap={2} mt='18px'>
        <BorderBox width='200px' position='relative'>
        ...
        <GenerateReferralBorderBox className={isRefCodeButtonMouseEnter ? 'hover' : ''} width='200px' position='relative' onClick={goBackShowReferral}>
          {isGeneratingRefCode ?
