    ...
    <>
      <Box padding='15px'>
        {!noBorrowedAsset &&
          <Box>
            <Stack direction="row" justifyContent="space-between">
              ...
              <Box><Typography variant='p_lg'>{Math.abs(cometDetail.ild).toLocaleString(undefined, { maximumFractionDigits: 5 })} {cometDetail.ildInUsdi ? 'onUSD' : cometDetail.tickerSymbol}</Typography></Box>
            </Stack>
            <Stack direction="row" justifyContent="space-between" mt='5px'>
              <Box><Typography variant='p_lg'>{cometDetail.ildInUsdi ? 'onUSD' : cometDetail.tickerSymbol} Wallet Balance</Typography></Box>
              <Box><Typography variant='p_lg' color={notEnoughBalance ? '#ed2525' : '#fff'}>{balance.toLocaleString(undefined, { maximumFractionDigits: 5 })} {cometDetail.ildInUsdi ? 'onUSD' : cometDetail.tickerSymbol}</Typography></Box>
            </Stack>
        ...
        <Stack direction="row" justifyContent="space-between" mt="25px">
          ...
          <Box><Typography variant='p_lg' color={noBorrowedAsset ? '#fff' : '#989898'}>{cometDetail.collAmount.toLocaleString(undefined, { maximumFractionDigits: 5 })} onUSD</Typography></Box>
        </Stack>
