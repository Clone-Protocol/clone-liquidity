...
const ClosePanel = ({ assetId, borrowDetail }: { assetId: string, borrowDetail: BorrowDetail }) => {
  ...
  const debtAmountTooltipText = `The amount of iAsset that you owe.`
  const indebtedAssetWalletBalanceTooltipText = `Amount of iAsset held in your wallet`
  const collateralTooltipText = `The amount of collateral backing your borrow position.`
  const collateralWithdrawTooltipText = `The amount of collateral that you can withdraw after closing the borrow position.`
      ...
      <Box sx={{ padding: '30px', background: 'rgba(21, 22, 24, 0.75)', borderRadius: '10px', marginTop: '17px' }}>
        ...
        <Box sx={{ borderRadius: '10px', backgroundColor: 'rgba(255, 255, 255, 0.08)', padding: '11px 24px 9px 27px'}}>
          <Stack direction="row" justifyContent="space-between">
            <DetailHeader>Debt Amount <InfoTooltip title={debtAmountTooltipText} /></DetailHeader>
          ...
          <Stack sx={{ marginTop: '10px' }} direction="row" justifyContent="space-between">
            <DetailHeader>Indebted Asset Wallet Balance <InfoTooltip title={indebtedAssetWalletBalanceTooltipText} /></DetailHeader>
          ...
          <Stack sx={{ marginTop: '10px' }} direction="row" justifyContent="space-between">
            <DetailHeader>Collateral <InfoTooltip title={collateralTooltipText} /></DetailHeader>
