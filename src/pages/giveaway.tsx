    ...
    <StyledSection sx={{ overflowX: 'hidden' }}>
      <Container>
        <Box sx={{ paddingX: { xs: '0px', md: '20px' } }}>
          <Box><Typography fontSize='20px' fontWeight={500}>Clone Classic Giveaway</Typography></Box>
          <Stack direction='row' alignItems='center' gap={1}>
            ...
            <a href="https://docs.clone.so/clone-mainnet-guide/points-program/season-1/cloner-classic-giveaway" target='_blank'>
              <Box display='flex' color='#b5fdf9' sx={{ cursor: 'pointer', ":hover": { color: '#4fe5ff' }, whiteSpace: 'nowrap' }}>
