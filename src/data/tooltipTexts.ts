export const TooltipTexts = {
    ...
    priceRange: `The range within which the designated comet postion will remain active. If the onAsset price leaves this range it is likely that the position will be subject to liquidation.`,
    ...
    iAssetPrice: `The price of the onAsset on Clone Markets, this value is calculated using the ratio of onUSD to onAsset in the pool.`,
    ...
    totalLiquidity: `The total amount of liquidity in USD being provided to Clone pools by your multipool comet.`,
    contributedLiquidityPositions: `This is where you can add liquidity to any of Clone's pools using your multipool comet.`,
    ...
    iAssetCol: `The price of the onAsset on Clone Markets, this value is calculated using the ratio of onUSD to onAsset in the pool.`,
    liquidityiAssetCol: `Number of onAsset you have provided to the pool using this unconcentrated liquidity position.`,
    liquidityUSDiCol: `Number of onUSD you have provided to the pool using this unconcentrated liquidity position.`,
    ...
    cometLiquidity: `The Comet Liquidity interface allows you to establish a new single pool comet position where one source of collateral will back a concentrated liquidty position for one onAsset pool.`,
    ...
    concentrationRange: `The range within which the designated comet postion will remain active. If the onAsset price leaves this range it is likely that the position will be subject to liquidation.`
}