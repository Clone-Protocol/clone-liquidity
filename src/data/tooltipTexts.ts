export const TooltipTexts = {
    priceIndicator: `The price of the clAsset on Clone Markets, this value is calculated using the ratio of devUSD to clAsset in the pool.`,
    totalValue: `Represents the total value of all your positions on Clone Liquidity.`,
    collateralRatio: `Designates the ratio in terms of value of the collateral and the borrowed clAsset. For example, if you borrow $100 of onSOL with 200 devUSD, then the collateral ratio is 200%. A borrow position is subject to liquidation if the ratio falls below 150%, but we recommend opening a position with a safer ratio of atleast 250%.`,
    ...
    setCollateralRatio: `Designates the ratio in terms of value of the collateral and the borrowed clAsset. example, if you borrow $100 of iSOL with 200 devUSD, then the collateral ratio is 200%. A borrow position is subject to liquidation if the ratio falls below 150%, but we recommend opening a position with a safer ratio of atleast 250%.`,
    ...
    onAssetPrice: `The price of the clAsset on Clone Markets, this value is calculated using the ratio of devUSD to clAsset in the pool.`,
    ...
    onAssetCol: `The price of the clAsset on Clone Markets, this value is calculated using the ratio of devUSD to clAsset in the pool.`,
    ...
    unconcentratedLiquidity: `The Unconcentrated Liquidity interface allows you to provide liquidity to pools in the traditional way,by adding both devUSD and clAsset directly from your wallet.`,
    ...
    onAssetToBorrow: 'clAsset to Borrow',
