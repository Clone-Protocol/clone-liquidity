export const TooltipTexts = {
    priceIndicator: `The price of the iAsset on Incept Markets, this value is calculated using the ratio of onUSD to iAsset in the pool.`,
    totalValue: `Represents the total value of all your positions on Incept Liquidity.`,
    collateralRatio: `Designates the ratio in terms of value of the collateral and the borrowed iAsset. For example, if you borrow $100 of iSOL with 200 onUSD, then the collateral ratio is 200%. A borrow position is subject to liquidation if the ratio falls below 150%, but we recommend opening a position with a safer ratio of atleast 250%.`,
    ...
    cometdHealthScore: `The health score gives you a sense of the level of danger of your comet. A higher score means a lower risk of future liquidation. If the score reaches 0, the position is subject to liquidiation.`,
    ...
    setCollateralRatio: `Designates the ratio in terms of value of the collateral and the borrowed iAsset. example, if you borrow $100 of iSOL with 200 onUSD, then the collateral ratio is 200%. A borrow position is subject to liquidation if the ratio falls below 150%, but we recommend opening a position with a safer ratio of atleast 250%.`,
    ...
    projectedHealthScore: `The approximate health score of the comet after editting the liquidity position.`,
    iAssetPrice: `The price of the iAsset on Incept Markets, this value is calculated using the ratio of onUSD to iAsset in the pool.`,
    ...
    iAssetCol: `The price of the iAsset on Incept Markets, this value is calculated using the ratio of onUSD to iAsset in the pool.`,
    ...
    unconcentratedLiquidity: `The Unconcentrated Liquidity interface allows you to provide liquidity to pools in the traditional way,by adding both onUSD and iAsset directly from your wallet.`,
