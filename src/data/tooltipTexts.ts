export const TooltipTexts = {
    ...
    ildDebt: `The D stands for Debt in ILD so remove Debt from this, then (?) should be: Stands for Impermanent Loss Debt and represents the amount of debt needed to be payed to offset the impermanent loss and close the position.`,
    ...
    projectedMultipoolHealthScore: `The approximate health score of the multipool comet after altering the total collateral value.`,
